...
namespace AC
{
    ...
    [SerializeField] private int memoryEffect;
            ...
            if (npcToEffect.GetComponent<CharacterMemory>() == null) {
                ...
                if (characterMemory.memories != null) {
                    ...
                    if (memories.memory.Count < 1) {
                        ...
                        memoryEffect = EditorGUILayout.Popup("Reference value:", memoryEffect, options.ToArray());
                        memoryIndex = memories.memory[memoryEffect].memoryIndex;
